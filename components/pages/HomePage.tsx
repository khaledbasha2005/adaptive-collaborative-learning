...
const HomePage: React.FC = () => {
  return (
    <div>
      <div className="bg-blue-700 text-white p-8 rounded-xl shadow-lg mb-8">
        <h1 className="text-3xl font-bold mb-2">مرحباً بك في بيئة التعلم التكيفية التشاركية</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h2 className="text-2xl font-bold text-red-600 mb-4">عزيزي الطالب</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
           <h2 className="text-2xl font-bold text-red-600 mb-4">تعليمات بيئة التعلم</h2>
